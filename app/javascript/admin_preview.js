document.addEventListener('DOMContentLoaded', function(){
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('name', 'admin_item[images][]');

    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('input[type="file"][name="admin_item[images][]"]:last-child');
  ...
  const changedFileField = (e) => {
   ...
   // input要素を取得
   const fileField = document.querySelector('input[type="file"][name="admin_item[images][]"]');
